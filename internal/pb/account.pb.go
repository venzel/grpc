...
var file_proto_account_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xf2, 0x01, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x28, 0x01, 0x12, 0x2c, 0x0a, 0x0c, 0x4c, 0x69, 0x73,
	0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x62,
	0x6c, 0x61, 0x6e, 0x6b, 0x1a, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x32, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x41, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x15, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0b, 0x2e, 0x70,
	0x62, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x69,
...
var file_proto_account_proto_depIdxs = []int32{
	...
	0, // 3: pb.AccountService.ListAccounts:input_type -> pb.blank
	4, // 4: pb.AccountService.GetAccount:input_type -> pb.AccountGetRequest
	1, // 5: pb.AccountService.CreateAccount:output_type -> pb.Account
	3, // 6: pb.AccountService.CreateAccountStream:output_type -> pb.AccountList
	3, // 7: pb.AccountService.ListAccounts:output_type -> pb.AccountList
	1, // 8: pb.AccountService.GetAccount:output_type -> pb.Account
